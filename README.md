...
**Schemer en Nacht** is een aparte serverless app (niet via GitHub Pages): zie [nachtcalendar/README.md](nachtcalendar/README.md).

```bash
cd nachtcalendar && npm install && npm run dev:node
```
